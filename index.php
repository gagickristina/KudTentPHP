...
<body id="page-top">
    ...
    <?php include "php/portfolio1.php"; ?>
    <?php include "php/portfolio2.php"; ?>
    <?php include "php/portfolio3.php"; ?>
    <?php include "php/portfolio4.php"; ?>
    <?php include "php/portfolio5.php"; ?>
    <?php include "php/portfolio6.php"; ?>
