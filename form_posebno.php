   ...
   <section class="page-section bg-dark">
       <div class="container">
        ...
        <div class="text-center">
            ...
            <h3 class="section-subheading text-muted">Ovde mozete proveriti da li ste prisustvovali na poslednjoj probi i da li ste platili mesečnu članarinu.</h3>
        </div>
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
                ...
                <form name="registracija" action="registration.php" method="post">
                  <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{5,}$" name="nLozinka" placeholder="Unestite lozinku." required>
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-secondary" onClick="provera()">Registruj se</button>
            </form>
    ...
    <div class="card">
      <div class="card-body">
         ...
         <form action="login.php" method="post">
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Email adresa:</label>
            <input type="email" class="form-control" id="exampleInputEmail1" name="nEmail" placeholder="Unestite email adresu.">

        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Lozinka:</label>
            <input type="password" class="form-control" id="exampleInputPassword1" name="nLozinka" placeholder="Unestite lozinku.">
        </div>
